...
import com.practicum.playlistmaker.databinding.RecyclerViewPlaylistBinding
import com.practicum.playlistmaker.media.domain.models.Playlist

class PlaylistViewHolder (private val binding: RecyclerViewPlaylistBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    companion object{
        fun from(parent: ViewGroup): PlaylistViewHolder {
            ...
            val binding = RecyclerViewPlaylistBinding.inflate(inflater, parent, false)
